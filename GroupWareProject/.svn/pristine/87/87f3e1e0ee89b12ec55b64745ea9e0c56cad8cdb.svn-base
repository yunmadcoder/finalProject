					...
					<div class="px-4 pt-9 pb-6 d-none d-lg-block">
						<form id="searchForm">
							...
							<div class="d-flex align-items-center">
								<div class="col-6">
									<div>
										<span class="fs-5 fw-bold"><i class="ti ti-trash fs-5"></i> 휴지통</span> <span>&nbsp;&nbsp;휴지통 ${pagingVO.totalRecord } / 안읽은메일 ${noRead }</span>
									</div>
								</div>
								<div class="col-6">
								...
								<div class="modal-body">
									<form id="searchDetailForm">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="searchreceiver">
											</div>
										</div>
										<div class="mb-3 row">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="searchAttach">
											</div>
										</div>
									</form>
								</div>
						...
						<div class="container-fluid">
							<div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
								<ul class="navbar-nav">
									...
									<li class="nav-item"><span id="clear"><label for="clear" style="cursor: pointer;"><i class="ti ti-trash fs-5"></i>영구삭제</span></label></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<li class="nav-item"><span id="recover"><label for="recover" style="cursor: pointer;"><i class="ti ti-inbox fs-5"></i>되돌리기</span></label></li>
								</ul>
							</div>
						</div>
					</nav>
