...
function createFileHTML(msg) {
	...
	if(emplNo == msg.emplNo) {
		...
		html += '	<div class="p-2 text-bg-light rounded-1 d-inline-block text-dark fs-3" style="max-width:200px;">';
...
function createRecipientHTML(msg) {
	...
	if(msg.atchFileGroupNo > 0) {
		...
		html += '		<div class="text-bg-light rounded-1 d-inline-block text-dark fs-3" style="padding:9px; font-size:16px;">'+msg.mssagCn+'</div>';
	}
...
function createSenderHTML(msg) {
	...
	html += '<div class="text-end mb-3" data-id="'+msg.emplNo+'"> ';
	if(msg.atchFileGroupNo > 0) {
		html += '	<div class="p-2 bg-info-subtle text-dark rounded-1 d-inline-block fs-3" style="max-width:200px;">';
